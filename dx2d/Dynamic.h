...
namespace Viva
{
	...
	public:
		...
		void SetPosition(XMVECTOR&& v) { position = v; }
		void SetPosition(const XMVECTOR& v) { position = v; }
		...
		void SetVelocity(XMVECTOR&& v) { velocity = v; }
		void SetVelocity(const XMVECTOR& v) { velocity = v; }
		...
		void SetAcceleration(XMVECTOR&& v) { acceleration = v; }
		void SetAcceleration(const XMVECTOR& v) { acceleration = v; }
		...
		void SetRotation(XMVECTOR&& v) { rotation = v; }
		void SetRotation(const XMVECTOR& v) { rotation = v; }
		...
		void SetAngularVelocity(XMVECTOR&& v) { angularVelocity = v; }
		void SetAngularVelocity(const XMVECTOR& v) { angularVelocity = v; }
		...
		void SetAngularAcceleration(XMVECTOR&& v) { angularAcceleration = v; }
		void SetAngularAcceleration(const XMVECTOR& v) { angularAcceleration = v; }
